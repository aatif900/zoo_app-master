...
class AnimalDetailsPage extends StatefulWidget {
  const AnimalDetailsPage({Key? key, required this.model}) : super(key: key);
  final String model;
...
class _AnimalDetailsPageState extends State<AnimalDetailsPage>
  ...
  late Animation<double> _modelDrivingAnimation;
  late Animation<double> _containerDrivingAnimation;
  late Animation<double> _buttonDrivingAnimation;

  late ZooDictionary _dictionary;
...
class _PandaTableEntry extends StatelessWidget {
  final String title;
  final String value;
  const _PandaTableEntry({Key? key, required this.title, required this.value})
      : super(key: key);
